...
static PyMethodDef servicios__methods[] = {
  {NULL, NULL, 0, NULL}  /* sentinel */
};

static struct PyModuleDef servicios__module = {
...
PyMODINIT_FUNC
PyInit_servicios_s__rosidl_typesupport_introspection_c(void)
{
  PyObject * pymodule = NULL;
  pymodule = PyModule_Create(&servicios__module);
  if (!pymodule) {
    return NULL;
  }
  int8_t err;
