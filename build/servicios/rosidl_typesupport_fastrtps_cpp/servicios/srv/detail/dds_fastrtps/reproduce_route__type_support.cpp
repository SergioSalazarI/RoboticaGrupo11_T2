...
#include "servicios/srv/detail/reproduce_route__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const servicios::srv::ReproduceRoute_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<servicios::srv::ReproduceRoute_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ReproduceRoute_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const servicios::srv::ReproduceRoute_Request *>(
...
static size_t _ReproduceRoute_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ReproduceRoute_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ReproduceRoute_Request__callbacks = {
  "servicios::srv",
...
static rosidl_message_type_support_t _ReproduceRoute_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ReproduceRoute_Request__callbacks,
...
{
  return &servicios::srv::typesupport_fastrtps_cpp::_ReproduceRoute_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const servicios::srv::ReproduceRoute_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<servicios::srv::ReproduceRoute_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ReproduceRoute_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const servicios::srv::ReproduceRoute_Response *>(
...
static size_t _ReproduceRoute_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ReproduceRoute_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ReproduceRoute_Response__callbacks = {
  "servicios::srv",
...
static rosidl_message_type_support_t _ReproduceRoute_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ReproduceRoute_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &servicios::srv::typesupport_fastrtps_cpp::_ReproduceRoute_Response__handle;
}
...
static service_type_support_callbacks_t _ReproduceRoute__callbacks = {
  "servicios::srv",
  "ReproduceRoute",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, servicios, srv, ReproduceRoute_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, servicios, srv, ReproduceRoute_Response)(),
...
static rosidl_service_type_support_t _ReproduceRoute__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ReproduceRoute__callbacks,
...
{
  return &servicios::srv::typesupport_fastrtps_cpp::_ReproduceRoute__handle;
}
