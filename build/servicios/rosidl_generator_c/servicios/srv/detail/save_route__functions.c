...
servicios__srv__SaveRoute_Request__create()
{
  ...
  servicios__srv__SaveRoute_Request * msg = (servicios__srv__SaveRoute_Request *)allocator.allocate(sizeof(servicios__srv__SaveRoute_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(servicios__srv__SaveRoute_Request));
  bool success = servicios__srv__SaveRoute_Request__init(msg);
  if (!success) {
...
servicios__srv__SaveRoute_Request__Sequence__init(servicios__srv__SaveRoute_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  servicios__srv__SaveRoute_Request * data = NULL;

  if (size) {
    data = (servicios__srv__SaveRoute_Request *)allocator.zero_allocate(size, sizeof(servicios__srv__SaveRoute_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = servicios__srv__SaveRoute_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        servicios__srv__SaveRoute_Request__fini(&data[i - 1]);
      }
...
servicios__srv__SaveRoute_Request__Sequence__fini(servicios__srv__SaveRoute_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      servicios__srv__SaveRoute_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  servicios__srv__SaveRoute_Request__Sequence * array = (servicios__srv__SaveRoute_Request__Sequence *)allocator.allocate(sizeof(servicios__srv__SaveRoute_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = servicios__srv__SaveRoute_Request__Sequence__init(array, size);
  if (!success) {
...
servicios__srv__SaveRoute_Request__Sequence__destroy(servicios__srv__SaveRoute_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    servicios__srv__SaveRoute_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
servicios__srv__SaveRoute_Request__Sequence__are_equal(const servicios__srv__SaveRoute_Request__Sequence * lhs, const servicios__srv__SaveRoute_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!servicios__srv__SaveRoute_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  servicios__srv__SaveRoute_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(servicios__srv__SaveRoute_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    servicios__srv__SaveRoute_Request * data =
      (servicios__srv__SaveRoute_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!servicios__srv__SaveRoute_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          servicios__srv__SaveRoute_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!servicios__srv__SaveRoute_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  servicios__srv__SaveRoute_Response * msg = (servicios__srv__SaveRoute_Response *)allocator.allocate(sizeof(servicios__srv__SaveRoute_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(servicios__srv__SaveRoute_Response));
  bool success = servicios__srv__SaveRoute_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
servicios__srv__SaveRoute_Response__Sequence__init(servicios__srv__SaveRoute_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  servicios__srv__SaveRoute_Response * data = NULL;

  if (size) {
    data = (servicios__srv__SaveRoute_Response *)allocator.zero_allocate(size, sizeof(servicios__srv__SaveRoute_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = servicios__srv__SaveRoute_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        servicios__srv__SaveRoute_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
servicios__srv__SaveRoute_Response__Sequence__fini(servicios__srv__SaveRoute_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      servicios__srv__SaveRoute_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  servicios__srv__SaveRoute_Response__Sequence * array = (servicios__srv__SaveRoute_Response__Sequence *)allocator.allocate(sizeof(servicios__srv__SaveRoute_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = servicios__srv__SaveRoute_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
servicios__srv__SaveRoute_Response__Sequence__destroy(servicios__srv__SaveRoute_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    servicios__srv__SaveRoute_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
servicios__srv__SaveRoute_Response__Sequence__are_equal(const servicios__srv__SaveRoute_Response__Sequence * lhs, const servicios__srv__SaveRoute_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!servicios__srv__SaveRoute_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  servicios__srv__SaveRoute_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(servicios__srv__SaveRoute_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    servicios__srv__SaveRoute_Response * data =
      (servicios__srv__SaveRoute_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!servicios__srv__SaveRoute_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          servicios__srv__SaveRoute_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!servicios__srv__SaveRoute_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
