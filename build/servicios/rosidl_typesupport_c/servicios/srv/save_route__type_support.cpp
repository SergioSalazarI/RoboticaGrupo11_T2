...
static const _SaveRoute_Request_type_support_symbol_names_t _SaveRoute_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, servicios, srv, SaveRoute_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, servicios, srv, SaveRoute_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, servicios, srv, SaveRoute_Request)() {
  return &::servicios::srv::rosidl_typesupport_c::SaveRoute_Request_message_type_support_handle;
}
...
static const _SaveRoute_Response_type_support_symbol_names_t _SaveRoute_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, servicios, srv, SaveRoute_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, servicios, srv, SaveRoute_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, servicios, srv, SaveRoute_Response)() {
  return &::servicios::srv::rosidl_typesupport_c::SaveRoute_Response_message_type_support_handle;
}
...
static const _SaveRoute_type_support_symbol_names_t _SaveRoute_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, servicios, srv, SaveRoute)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, servicios, srv, SaveRoute)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, servicios, srv, SaveRoute)() {
  return &::servicios::srv::rosidl_typesupport_c::SaveRoute_service_type_support_handle;
}
